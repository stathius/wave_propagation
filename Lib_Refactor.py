...
class Data_Analyser():
    ...
    Validation loss
    """
    def __init__(self, maindir1, Type_Network, version):
        self.epoch_loss = []
        self.epoch_nr = []
        self.batch_loss = []
        self.batch_nr = []
    ...
    def plot_loss(self):
        ...
        figure_save(self.maindir1 + "Epoch_Loss" + self.Type_Network + "_Project_v%03d" % self.version, obj=fig)
        plt.show()
    ...
    def plot_loss_batchwise(self):
        ...
        sns.lineplot(x="Batch", y="Loss",
                     data=pd.DataFrame.from_dict(data), ax=fig)
        figure_save(self.maindir1 + "Batch_Loss" + self.Type_Network + "_Project_v%03d" % self.version, obj=fig)
        plt.show()
    ...
    def plot_accuracy(self):
        ...
        sns.lineplot(x="Epoch", y="Accuracy",
                     data=pd.DataFrame.from_dict(data), ax=fig)
        figure_save(self.maindir1 + "Accuracy" + self.Type_Network + "_Project_v%03d" % self.version, obj=fig)
        plt.show()
    ...
    def plot_validation_loss(self):
        ...
        sns.lineplot(x="Epoch", y="Loss", hue="hue",
                     data=pd.DataFrame.from_dict(data), ax=fig)
        figure_save(self.maindir1 + "Validation_Loss" + self.Type_Network + "_Project_v%03d" % self.version, obj=fig)
        plt.show()
