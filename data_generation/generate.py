...
def get_args():
    ...
    parser.add_argument('--container_size_min', type=int, default=10, help='Minumum size of the water container')
    parser.add_argument('--container_size_max', type=int, default=20, help='Maximum size of the water container')
