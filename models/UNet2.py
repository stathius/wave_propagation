...
class UNet(nn.Module):
    def __init__(
        ...
        Args:
            num_input_frames (int): number of input channels
            num_output_frames (int): number of output channels
        ...
        self.depth = depth
        prev_channels = num_input_frames
        ...
        self.last = nn.Conv2d(prev_channels, num_output_frames, kernel_size=1)
