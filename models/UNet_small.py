...
class UNet_small(nn.Module):
    ...
    def __init__(self, num_input_frames, num_output_frames, layers):
        super().__init__()
        self.num_input_frames = num_input_frames
        self.num_output_frames = num_output_frames
        self.dconv_down1 = double_conv(num_input_frames, layers)
        self.dconv_down2 = double_conv(layers, layers*2)
        self.dconv_down3 = double_conv(layers*2, layers*4)
        ...
        self.dconv_up2 = double_conv(layers*(2 +4), layers*2)
        self.dconv_up1 = double_conv(layers*(1 +2), layers)

        self.conv_last = nn.Conv2d(layers, num_output_frames, 1)
