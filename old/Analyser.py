...
class Analyser():
    ...
    def plot_loss(self):
        ...
        save_figure(os.path.join(self.figures_dir, "Epoch_Loss"), obj=fig)
        plt.show()
    ...
    def plot_loss_batchwise(self):
        ...
        sns.lineplot(x="Batch", y="Loss",
                     data=pd.DataFrame.from_dict(data), ax=fig)
        save_figure(os.path.join(self.figures_dir, "Batch_Loss"), obj=fig)
        plt.show()
    ...
    def plot_validation_loss(self):
        ...
        save_figure(os.path.join(self.figures_dir, "Validation_Loss"), obj=fig)
        plt.show()
        return data
