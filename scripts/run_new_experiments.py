...
for exp, exp_args in new_experiments.items():
    ...
    exp_name = '{model_type}_batch_{batch_size}_samples_{samples_per_sequence}_epoch_{num_epochs}_in_{num_input_frames}_out_{num_output_frames}_normalizer_{normalizer_type}'.format(**exp_args)
