...
python train_convlstm.py --experiment_name "ConvLSTM_batch16_samples_5_epoch30_out1" --batch_size 16 --num_epochs 30 --samples_per_sequence 5 --num_input_frames 5 --num_output_frames 1